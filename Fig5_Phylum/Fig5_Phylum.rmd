...
```{r}
sizegenome=read.csv(file.path("../OutputData", "Tillage_GMs_Growth_rates_GenomeSize_CazymeGenes.csv")) 
```
...
```{r}
cazygenes= read.csv(file = "../OutputData/Tillage_GMs_Growth_rates_GenomeSize_CazymeGenes.csv")
```
